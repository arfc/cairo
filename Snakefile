...
rule make_loss_plots:
    ...
    output:
        ...
        "figures/lorenz63_n_reservoir_sparsity_loss.png",
        "figures/lorenz63_trainlen_loss.png",
        #"figures/48_{scenario}_rho_noise_loss.png",
        #"figures/48_{scenario}_n_reservoir_sparsity_loss.png",
        #"figures/48_{scenario}_trainlen_loss.png",
        #"figures/04_{scenario}_rho_noise_loss.png",
        #"figures/04_{scenario}_n_reservoir_sparsity_loss.png",
        #"figures/04_{scenario}_trainlen_loss.png",
    script:
        "loss_plots.py"
