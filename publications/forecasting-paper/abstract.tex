...
solar power with echo state networks. Simulation results show that forecasts
can be significantly improved by some additional predictors. We found that
solar elevation angle was the only parameter that improved the forecast in
every case. Other parameters must be chosen carefully for each application. Forecast improvements from properly chosen training inputs are comparable to the accuracy from more sophisticated algorithms
\end{abstract}
