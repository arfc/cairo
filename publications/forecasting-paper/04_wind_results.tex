\begin{figure}[H]
  ...
  % \includegraphics[width=0.8\textwidth]{04_wind_wettemp_prediction.png}
    \resizebox{\columnwidth}{!}{\input{./images/04_wind_windspeed_prediction.pgf}}
  \caption{The optimized 4 hour ahead wind energy prediction. The training inputs for this forecast were historical wind energy and hourly windspeed. \textit{Hyperparameters}: Reservoir Size:1000, Sparsity: 0.15, Spectral Radius: 0.9, Noise: 0.001, Training Length: 14300, Prediction Window: 4, Random state: 85}
  \label{fig:wind04}
\end{figure}
\FloatBarrier
% \begin{center}
