...
if __name__ == '__main__':
    ...
    # import raw data -- the raw data is available on the box website.
    ...
    weather_df.rename(columns={'HourlyDryBulbTemperature': 'TEMP',
                               'HourlyPrecipitation': 'PREC'}, inplace=True)
